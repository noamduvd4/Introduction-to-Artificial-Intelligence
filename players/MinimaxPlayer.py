...
import numpy as np
from SearchAlgos import MiniMax, TimeOut
...
class Player(AbstractPlayer):
    def __init__(self, game_time):
        ...
        self.algo_to_search = MiniMax(self.utility, self.succ, None, self.goal)
    ...
    def make_move(self, time_limit):
        ...
        """
        # TODO: erase the following line and implement this function.
        move = self._iterative_minmax_algoritem(time_limit)
        self.turn += 1
        return move
