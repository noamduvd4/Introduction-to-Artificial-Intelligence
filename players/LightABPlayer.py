...
class Player(AbstractPlayer):
    def __init__(self, game_time):
        ...
        #TODO: initialize more fields, if needed, and the AlphaBeta algorithm from SearchAlgos.pyֿ
        self.algo_to_search = AlphaBeta(self._ligth_utility ,self.succ, None, self.goal)
    ...
    def _ligth_utility(self, state, turn , maximizing_player):
        return self._number_of_player_pieces_hur(state)
